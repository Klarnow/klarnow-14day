...
const Hero = () => {
  return <section className="relative hero-gradient min-h-[85vh] md:min-h-screen flex items-center justify-center pt-16 pb-12 md:pt-20 md:pb-16 overflow-hidden">
